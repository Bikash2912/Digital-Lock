    ...
    if (rst) begin
        ...
        3'd0: begin  
            case (state_fsm)
                ...
                5'd2: begin data_buf <= 8'h28; lcd_rs <= 0; end  
                5'd3: begin data_buf <= 8'h0C; lcd_rs <= 0; end  
                5'd4: begin data_buf <= 8'h06; lcd_rs <= 0; end  
                5'd5: begin data_buf <= 8'h01; lcd_rs <= 0; end  
                5'd6: begin data_buf <= 8'h80; lcd_rs <= 0; idx <= 0; end  
                5'd7: begin data_buf <= msg[idx]; lcd_rs <= 1; end
                5'd8: begin data_buf <= 8'hC0; lcd_rs <= 0; idx <= 8; end  
